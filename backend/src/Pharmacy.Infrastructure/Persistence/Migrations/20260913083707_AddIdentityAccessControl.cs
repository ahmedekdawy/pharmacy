        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    full_name_ar = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    full_name_en = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    is_active = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_role_pages", x => x.id);
                    table.ForeignKey(
                        name: "FK_role_pages_pages_page_id",
                        column: x => x.page_id,
                        principalTable: "pages",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_role_pages_roles_role_id",
                        column: x => x.role_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_role_pages_page_id",
                table: "role_pages",
                column: "page_id");

            migrationBuilder.CreateIndex(
                name: "IX_role_pages_role_id",
                table: "role_pages",
                column: "role_id");

            migrationBuilder.CreateIndex(
                name: "ix_role_pages_tenant_role_page",
                table: "role_pages",
                columns: new[] { "tenant_id", "role_id", "page_id" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_role_permissions_tenant_role_permission",
                table: "role_permissions",

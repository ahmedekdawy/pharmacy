...
public static class PermissionCodes
{
    ...
    public const string PurchaseReceive = "Purchase.Receive";
    ...
    public const string CashShiftOpen = "CashShift.Open";
    public const string CashShiftClose = "CashShift.Close";
